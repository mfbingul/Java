...
private static DBsorgu sorgu = new DBsorgu();
    ...
    public void sqlSorgu(){
        ...
        try
        {   //Bağlantı kurulumu.
            Connection conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres","postgres","2391a3a2343b58d9.");
            if (conn != null)
            ...
            String sql= "SELECT \"user\" , \"password\" FROM \"kullanici\"";
